...
class ErrorHandler(commands.Cog, name="Error Handler"):
    ...
    def error_embed(title: str, message: str) -> discord.Embed:
        ...
        return discord.Embed(title=title, description=message, colour=disnake.Colour.red())
    ...
    async def handle_bot_missing_perms(self, ctx: commands.Context, error: commands.BotMissingPermissions) -> bool:
